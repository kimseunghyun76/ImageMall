        ...
        <form class="form-horizontal" name="imgfrm" id="imgfrm" onsubmit="return onSubmitcheck();" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row" >
                        ...
                        <div class="col-sm-10" id="imageDiv${status.count}">
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h3>Image ${status.count} <a href="javascript:deleteImg('imageDiv${status.count}','/imgManage/deleteFile?image_files_seq=${file.image_files_seq}');" class="btn btn-primary" role="button">삭제</a></h3>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <a class="btn btn-warning" href="/imgManage/delete?image_seq=${imageInfo.image_seq}" role="button">정보 삭제</a>
...
<script src="<c:url value="/resources/css/productSearch.js" />"></script>
