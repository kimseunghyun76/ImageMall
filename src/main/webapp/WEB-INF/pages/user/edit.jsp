    ...
    <article class="container">
        ...
        <form class="form-horizontal" action="javascript:location.href='/admin/list'">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="email" class="form-control" id="inputEmail" placeholder="${user}" readonly style="color:#ccc">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="inputGroup" class="col-sm-2 control-label">조직명</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputGroup" placeholder="조직명">
                    <p class="help-block"></p>
                </div>
            </div>
            <div class="form-group">
                <label for="inputShop" class="col-sm-2 control-label">매장명</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputShop" placeholder="매장명">
                    <p class="help-block"></p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="inputCategory" placeholder="카테고리">
                    <p class="help-block"></p>
                </div>
            </div>
            <div class="form-group">
